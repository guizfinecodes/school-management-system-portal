...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="alumnistudent.php">Alumni Students<img src="assets/img/new.png"> </a></li>
               ...
               <div class="container-fluid">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Change Student to Alumni. [<a href="view_alumnistudents.php"><font color="yellow">Click here to view alumni students</font></a>]</div>
                        
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table"> 
                        <form action="alumnistudent.php" method="POST" enctype="multipart/form-data">
                          
                            <label>Student adm_number [<font color="red">*</font>]</label>
                            ...
                            <?php
                              ...
                              include('connect.php');
                                if (isset($_POST['register'])){
                                            ...
                                            $sql2="UPDATE `studentstable` SET `active`='no' WHERE `admission_number`='$admission_number'"; 

                                            $sql3="UPDATE parents SET  active='no'  WHERE admission_number = '$admission_number'";
                            ...
                            <?php
                                                    ...
                                                    window.location = "students.php?id=<?php echo $id;?>";
                                                    </script>
...
<!--****************************************************************************-->
 ...
 <!--*******************************try add parent's details******************************************************-->  
    ...
    <div div class="col-md-12" style="background-color:#526F35;bottom:0px; position:fixed;">
        <p class="text-center text-danger" style="color:white;">@G. Brian Tel: +254729734768</p>
    </div>
