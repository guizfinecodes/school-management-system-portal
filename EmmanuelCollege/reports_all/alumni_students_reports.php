...
$sql = "SELECT student_id AS ADM_NO ,course_id AS Course, `sirname`, `firstname`, `lastname`, `dateofbirth`, `gender`, `mobile`,reg_date AS Admission_Date FROM `studentstable` WHERE active='no'";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Emmanuel College Alumni List',0,0,'C',0);
