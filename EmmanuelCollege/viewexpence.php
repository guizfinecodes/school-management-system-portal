...
<link rel="stylesheet" type="text/css" href="style.css">
     ...
     <div class="header-top-info">
                ...
                <img src= "img/logo.JPG">
                            ...
                            <div class="col-md-4 col-sm-3 col-xs-6 text-left">
                                <a href="#"><i class="fa fa-phone"></i>0705060190</a>
                            </div>
                ...
                <nav>             
                    ...
                    //$totalfinal=$row['SUM(expence_amount)']; 
                        ...
                        ?>
                                                ...
                                                <td>
                                                <center><a href="delete_expence.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-delete"></i>Delete</a></center></td>                                            
                            </tr>
                                                <?php } ?>
                                                <tr>
