            ...
            <div class="container-fluid">
                ...
                <center><h4><strong>Enter marks, each student at a time</strong><h4></center>
                    ...
                    ?>
                                                ...
                                                <td>
                                                <center><a href="1_beauty1.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i>Enter Marks</a></center></td>
                                                <td>
                                                <center><a href="1_beautyprint.php <?php echo '?id='.$id; ?>" class="btn btn-info"><i class="glyphicon glyphicon-print"></i>Print Transcript</a></center></td>
