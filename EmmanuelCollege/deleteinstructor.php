...
if (isset($_POST['delete'])){
    ...
    $del=$_POST['instructor'];

    $sql="DELETE FROM instructors WHERE instructor_id='$del'";
    mysqli_query($db,$sql);  
    if ($sql){            
     echo '<script>
            alert("Record Succsessfully deleted!!");
            window.location = "instructors.php?id=<?php echo $id;?>";
            </script>';
    }else
    {
        echo '<script>
...
<!--****************************************************************************-->
                        ...
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li ><a href="editinstructor.php">Edit instructor<img src="assets/img/update2.png"> </a></li>
                                  <li ><a href="csvinstructor.php">Import/Export CSV<img src="assets/img/view2.png"></a></li>
                                  <li class="active"><a href="deleteinstructor.php">Delete<img src="assets/img/delete2.png"></a></li>
                                </ul>
                            <br>
...
<h4><center><h4><strong>Select instructor to delete</strong></h4></center></h4>
                        ...
                        <form method="POST" action="deleteinstructor.php">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="instructor" class="form-control" value="<?php echo $id ; ?>">
                                            </td>
                                            <tr>
