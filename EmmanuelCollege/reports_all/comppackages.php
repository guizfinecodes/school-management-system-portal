...
$sql = "SELECT student_id AS ADM_NO , `sirname`, `firstname`, `lastname`, `dateofbirth`, `gender`, `mobile`,reg_date AS Admission_Date, `border` FROM `studentstable` WHERE course_id=32";
$resultset = mysqli_query($db, $sql) or die("database error:". mysqli_error($db));


$sql2 = "SELECT COUNT(gender) AS nu FROM studentstable WHERE course_id=32 AND gender='Male' ";
...
$sql3 = "SELECT COUNT(gender) AS nu FROM studentstable WHERE course_id=32 AND gender='Female' ";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Computer Packages Students',0,0,'C',0);
//C MEANS CENTERED
