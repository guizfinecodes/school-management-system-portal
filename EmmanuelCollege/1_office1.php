    ...
    <div class="container-fluid">
       <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="1_office1.php" method="POST" enctype="multipart/form-data">
                     <div style="float:left; position:relative">  
                       ...
                       <td> <select name="exam_series" class="form-control" required=""> 
                    ...
                    <h4><font color="green">Subjects</font></h4>
                            ...
                            <tr>
                            <td><label>office designing and implementation 
                            <input type="number" name="e" id="e" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                            <td><label>Front Office & Guests Relation 
                            <input type="number" name="f" id="f" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>Communication Skills 
                            <input type="number" name="g" id="g" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                            <td><label>Costing & Control 
                            <input type="number" name="h" id="h" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>office keeping & spacing 
                            <input type="number" name="i" id="i" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td><br>
                            <td><label>office pricing and marketing 
                            <input type="number" name="j" id="j" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                           </tr>
...
mysql_query("INSERT INTO
 marks(
    admission_number, course_id, term, year, exam_series, unit_1, unit_2, unit_3, unit_4, unit_5, unit_6, unit_7, unit_8, unit_9, unit_10, average )
     VALUES
