...
<body class="background_img" background="assets/img/33.jpg" >
    ...
    <div class="login-card">
        ...
        <form class="form-signin" action="login.php" method="POST" enctype="multipart/form-data"><span class="reauth-email"> </span>
            ...
            <p><select name="user_type" class="form-control" id="position" required="">
            <option>Admin</option>
    ...
    <div class="col-md-12" style="background-color:#191970; position:fixed;bottom:0px;">
