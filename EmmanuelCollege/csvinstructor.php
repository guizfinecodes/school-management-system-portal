...
<!--******************************Second tab section**********************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="csvinstructor.php">Import/Export CSV<img src="assets/img/view2.png"></a></li>
                ...
                <form class="form-horizontal" action="functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <button type="submit" id="submit" name="Importinstructor" class="btn btn-primary button-loading" data-loading-text="Loading...">Import</button>
                            </div>
                        </div>
    ...
    <form class="form-horizontal" action="functions.php" method="post" name="upload_excel"   
            ...
            <div class="form-group">
                    <div class="col-md-4 col-md-offset-4">
                        <input type="submit" name="Exportinstructor" class="btn btn-success" value="export to excel"/>
                    </div>
            </div>                    
    </form>           
 </div>
