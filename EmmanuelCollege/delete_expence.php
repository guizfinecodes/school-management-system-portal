...
function get_all_records(){
    ...
    if (mysqli_num_rows($result) > 0) {
     echo "<div class='table-responsive'><table id='myTable' class='table table-striped table-bordered'>
               <thead><tr><th>expence_id</th>
                          <th>expence_date</th>
                          <th>description</th>
                          <th>expence_amount</th>
                          <th>captured_by</th
                        </tr></thead><tbody>";
     ...
     while($row = mysqli_fetch_assoc($result)) {
         ...
         echo "<tr><td>" . $row['expence_id']."</td>
                   <td>" . $row['expence_date']."</td>
                   <td>" . $row['description']."</td>
                   <td>" . $row['expence_amount']."</td>
...
if (isset($_POST['delete'])){
    ...
    $sql="DELETE FROM expence WHERE expence_id='$del'";
    mysqli_query($db,$sql);  
    if ($sql){            
     echo '<script>
            alert("Record Succsessfully deleted!!");
            window.location = "viewexpence.php?id=<?php echo $id;?>";
            </script>';
    }else
    {
        echo '<script>
...
<!--****************************************************************************-->
                        ...
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="delete_expence.php">delete Expence<img src="assets/img/delete2.png"> </a></li>
                                </ul>
                            <br>
...
<h4><center><h4><strong>Select expence to delete</strong></h4></center></h4>
                ...
                <div class="row">
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-6" >
                        ...
                        <form method="POST" action="delete_expence.php">

                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                                                               
                                        <tr>
                                            <td>
                                                <label>expence ID</label>
                                            </td>
                                            <td>
                                                <input type="text" name="expence" class="form-control" value="<?php echo $id; ?>">
                                            </td>
                                            <tr>
                                                <td colspan="2"><input type="submit" name="delete" value="Delete" class="btn btn-danger" ></td>
                                            </tr>
                                            </tr>
                                    </table>
                                </form>
