...
$pdf->SetXY(50,50);
$pdf->Cell(100,5,'Emmanuel College Academic Transcript',0,0,'C',0);
//C MEANS CENTERED
...
$pdf->Cell(0,10,'unit 1                                                                                                      '.$FBM ,0,1);
$pdf->Cell(0,10,'unit 2                                                                                                      '.$R_SERVICE ,0,1);
$pdf->Cell(0,10,'unit 3                                                                                                      '.$CT_PB ,0,1);
$pdf->Cell(0,10,'unit 4                                                                                                      '.$FOOD_SCIENCE ,0,1);
$pdf->Cell(0,10,'unit 5                                                                                                      '.$FUNDAMENTALS ,0,1);
$pdf->Cell(0,10,'unit 6                                                                                                      '.$FRONT_OFFICE ,0,1);
$pdf->Cell(0,10,'unit 7                                                                         '.$COMUNICATION_SKILLS ,0,1);
$pdf->Cell(0,10,'unit 8                                                                               '.$COSTING ,0,1);
$pdf->Cell(0,10,'unit 9                                             '.$HOUSEKEEPING ,0,1);
$pdf->Cell(0,10,'unit 10                                                                 '.$FB_PRACTICAL ,0,1);
$pdf->SetFont('','B');
