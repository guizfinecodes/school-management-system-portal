...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li ><a href="delete_expence.php">delete Expence<img src="assets/img/delete2.png"> </a></li>
                                </ul>
                            <br>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          ...
                          <h4>Expence Details</h4>
                            ...
                            <label>Date</label>
                            <input type="date" name="expence_date" readonly class="form-control" value="<?php echo date('Y-m-d'); ?>">
                            ...
                            <label>Amount</label>
                            <input type="number" name="expence_amount" required="" class="form-control">                                                                      
