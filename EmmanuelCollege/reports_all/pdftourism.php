...
$pdf->Cell(0,10,'Introduction to   tourism                                                                    '.$FBM ,0,1);
$pdf->Cell(0,10,'client interaction and  management                                                     '.$R_SERVICE ,0,1);
$pdf->Cell(0,10,'planning and management of tourism                                                 '.$CT_PB ,0,1);
$pdf->Cell(0,10,'entreprenuership engagement                                                              '.$FOOD_SCIENCE ,0,1);
$pdf->Cell(0,10,'exploration/field  skills                                                                        '.$FUNDAMENTALS ,0,1);
$pdf->Cell(0,10,'communication skills                                                                          '.$FRONT_OFFICE ,0,1);
