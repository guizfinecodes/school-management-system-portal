...
$pdf->Cell(0,10,'INTRODCUTION TO COMPUTERS                                                 '.$FBM ,0,1);
$pdf->Cell(0,10,'MS WINDOWS                                                                                    '.$R_SERVICE ,0,1);
$pdf->Cell(0,10,'MS WORD                                                                                          '.$CT_PB ,0,1);
$pdf->Cell(0,10,'MS EXCEL                                                                                           '.$FOOD_SCIENCE ,0,1);
$pdf->Cell(0,10,'MS ACCESS                                                                                       '.$FUNDAMENTALS ,0,1);
$pdf->Cell(0,10,'MS POWERPOINT                                                                           '.$FRONT_OFFICE ,0,1);
$pdf->Cell(0,10,'MS PUBLISHER                                                                               '.$COMUNICATION_SKILLS ,0,1);
$pdf->Cell(0,10,'INTERNET AND EMAIL                                                                    '.$COSTING ,0,1);
