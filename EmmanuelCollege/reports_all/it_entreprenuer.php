...
$sql = "SELECT  admission_number AS ADM_NO , `sirname`, `firstname`, `lastname`, `dateofbirth`, `gender`, `mobile`,reg_date AS Admission_Date FROM `studentstable` WHERE course_id=1";//`border` 
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'course (IT Entreprenuership) Students',0,0,'C',0);
//C MEANS CENTERED
