...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                    <li><a href="departments.php">view Departments<img src="assets/img/view2.png"> </a></li>
                                  <li class="active"><a href="newdepartments.php">New Department<img src="assets/img/new.png"> </a></li>
                                  <li><a href="editdepartments.php">Edit Department<img src="assets/img/update2.png"> </a></li>
                                  <li><a href="csvdepartments.php">Import/Export CSV<img src="assets/img/view2.png"></a></li>
                                  <li><a href="deletedepartment.php">Delete<img src="assets/img/delete2.png"></a></li>
                                </ul>
                            <br>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          ...
                          <form action="newdepartments.php" method="POST" enctype="multipart/form-data">
                          <h4>Department Details</h4>
                            ...
                            <input type="text" name="departmentname" class="form-control" required="">
                             <br>                                                                     
                            Head of Department:  
                             <input type="text" name="hod" class="form-control" required="">   
                            <br>                                                                
...
?>
                        ...
                        window.location = "newdepartments.php?id=<?php echo $id;?>";
                        </script>
<?php }?> 
