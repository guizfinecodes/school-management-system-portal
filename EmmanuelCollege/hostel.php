...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="hostel.php">New Room<img src="assets/img/new.png"> </a></li>

                                  <li><a href="manage_hostel.php">Manage Room <img src="assets/img/update2.png"> </a></li>
       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <label><font color="red"><i>last room number</i></font></label>
                        <i><font color="blue">
                                             <?php
                                                include('connect.php');
                                                $sql1="SELECT room_number FROM room order by room_id desc limit 1;";
                        ...
                        <!--<label><font color="red"><i>hostel name</i></font></label>
                        <i><font color="blue">
                                             <?php
                                                include('connect.php');
                                                $sql2="SELECT hostel_name from room,hostel where room.hostel_id= hostel.hostel_id";
                        ...
                        <input type="number" name="room_number" class="form-control" min="0" value="" required="">
                        <br>
                        ...
                        <option value="">select hostel name</option> 
                                             <?php
                                                include('connect.php');
                                                $sql1="SELECT hostel_name FROM hostel";
                                                $records1=mysqli_query($db,$sql1);
                                                    while($row=mysqli_fetch_array($records1,MYSQL_ASSOC))
                                                        {
                                                            echo "<option>".$row['hostel_name']."</option>";
                                                        }
                                                ?>
                                          </select>
                        <br>
...
<?php
    ...
    if (isset($_POST['register'])){
        ...
        $XX=$_POST['hostel_id'];
        $sql="SELECT * FROM hostel WHERE hostel_name='$XX'";
...
mysql_query("INSERT INTO room(room_number, hostel_id ) VALUES ('$room_number', '$hostel_id' )") or die(mysql_error());
...
?>
                        ...
                        alert('Room Succsessfully Saved.');
                        window.location = "hostel.php?id=<?php echo $id;?>";
                        </script>
<?php }?> 
