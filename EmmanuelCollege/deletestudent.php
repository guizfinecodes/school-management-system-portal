...
if (isset($_POST['register'])){
    ...
    $del=$_POST['student'];  
    $sql = "DELETE FROM studentstable WHERE admission_number='$del'";
    mysqli_query($db,$sql);  
    if ($sql){            
     echo '<script>
            alert("student Succsessfully deleted!!");
            window.location = "students.php?id=<?php echo $id;?>";
            </script>';;
    }else
    {
        echo '<script>
            alert("student not deleted. Contact admin");
            window.location = "students.php?id=<?php echo $id;?>";
            </script>';
    }
}
...
<!--****************************************************************************-->
                        ...
                        <div class="container" style="width:100%">
                                 ...
                                 <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="deletestudent.php">Delete Student <img src="assets/img/delete2.png"> </a></li>
...
<h4><center><h4><strong>Select student to delete</strong></h4></center></h4>
                        ...
                        <form method="POST" action="deletestudent.php">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="student" id="course" required="" class="form-control" value="<?php echo $id ; ?>">
                                            </td>
                                            <tr>
