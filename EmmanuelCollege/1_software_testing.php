...
<div id="page-wrapper">
            <div class="container-fluid">
                ...
                <center><h4><strong>Enter marks, each student at a time</strong><h4></center>
                    ...
                    <?php 
                    $idx=$_GET['id'];
                    $sql ="SELECT  * from studentstable where course_id='34'";
                    ...
                    ?>
                                                ...
                                                <td>
                                                <center><a href="1_software_testing1.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i>Enter Marks</a></center></td>
                                                <td>
