...
<div id="page-wrapper">
            <div class="container-fluid">
                ...
                <center><h4><strong>Students Form, Course:&nbsp;<?php echo $coursename; ?>&nbsp;fee payable&nbsp;<?php echo $fee; ?></strong><h4></center>
                    ...
                    $sql ="SELECT * from studentstable where active='yes' and course_id= '$id'";
                    $user_query=mysqli_query($db,$sql) or die("error getting data");
                    while($row = mysqli_fetch_array($user_query, MYSQLI_ASSOC)){
                    $id = $row['admission_number'];
                        ...
                        ?>
                                                ...
                                                <td><center><a href="deletestudent.php <?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash" name="register"></i>delete</a></center></td>
                                                <td><center><a href="alumnistudent.php <?php echo '?id='.$id; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i>alumni student?</a></center></td>
