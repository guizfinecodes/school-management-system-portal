...
$pdf->Cell(0,10,'office planning and selection                                                                 '.$FBM ,0,1);
$pdf->Cell(0,10,'front office management                                                                      '.$R_SERVICE ,0,1);
$pdf->Cell(0,10,'office maintenance                                                                                '.$CT_PB ,0,1);
$pdf->Cell(0,10,'practicals                                                                                                '.$FOOD_SCIENCE ,0,1);
$pdf->Cell(0,10,'office designing and implementation                                                     '.$FUNDAMENTALS ,0,1);
...
$pdf->Cell(0,10,'office keeping & spacing                                                                        '.$HOUSEKEEPING ,0,1);
$pdf->Cell(0,10,'office pricing and marketing                                                                 '.$FB_PRACTICAL ,0,1);
$pdf->SetFont('','B');
