    ...
    <div class="container-fluid">
       <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="1_beauty1.php" method="POST" enctype="multipart/form-data">
