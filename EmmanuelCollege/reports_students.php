...
<!--end of heading section-->  
    ...
    <div>
        <ul class="nav nav-tabs">
            ...
            <li><a href="sms.php">About <img src="assets/img/department.png"></a></li>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <form action="inventory.php" method="POST" enctype="multipart/form-data">
                                ...
                                <a href="reports_all/it_entreprenuer.php">It_entreprenuership programming students</a><br>
                                <a href="reports_all/foodandbeverage.php">Food and Beverage</a><br>
                                <a href="reports_all/beautyandtherapy.php">Beauty and hair Dressing skills </a><br> 
                                <a href="reports_all/businessmanagement.php">Business management 4</a> <br>
                                <a href="reports_all/tourismstudents.php">Tourism students</a><br>
                                <a href="reports_all/comppackages.php">Computer packages students</a><br>
                                <a href="reports_all/officemanagement.php">Ofice management students</a><br>
