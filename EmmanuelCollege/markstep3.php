            ...
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="markstep3.php" method="POST" enctype="multipart/form-data">
                    ...
                    <h4><font color="green">Subjects</font></h4>
                            ...
                            <tr>
                            <td><label>Housekeeping & Accomodation Studies 
                            <input type="number" name="i" id="i" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td><br>
                            <td><label>Food & Beverage Practical unit 
