...
<html lang="en">
    <head>
        ...
        <title>emmanuelcollege view units</title>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">view units available</li>
                                    </ul>
                                </div>
                        ...
                        <section class="section">
                            <div class="container-fluid">
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5><strong>UNITS REGISTERED </strong></h5>
                                                </div>
                                            </div>
                               ...
                               <?php 
                                ...
                                $sql = " SELECT * from units where course_id=(SELECT course_id FROM studentstable 
                                ...
                                $unit_id = $row['unit_id'];
                                 ...
                                 ?>
                                                ...
                                                <td><center><?php echo $row['unit_id']; ?></center></td>
                                               
                                                <td><center><?php echo $row['unit_name']; ?></center></td>
