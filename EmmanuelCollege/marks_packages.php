            ...
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="marks_packages.php" method="POST" enctype="multipart/form-data">
                    ...
                    <h4><font color="green">Subjects</font></h4>
                            ...
                            <input type="number" name="introduction_to_computers" id="a" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                            <td><label>MS WINDOWS
                            <input type="number" name="ms_windows" id="b" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>MS WORD
                            <input type="number" name="ms_word" id="c" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                            <td><label>MS EXCEL
                            <input type="number" name="ms_excel" id="d" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>MS ACCESS
                            <input type="number" name="ms_access" id="e" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                            <td><label>MS POWERPOINT
                            <input type="number" name="ms_powerpoint" id="f" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>MS PUBLISHER
                            <input type="number" name="ms_publisher" id="g" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td>
                            <td><label>INTERNET AND EMAIL
                            <input type="number" name="internet_and_email" id="h" class="form-control"  onkeyup="final()" min="0" max="100" >
                            </td></tr>
...
mysql_query("INSERT INTO
 marks(
    admission_number, course_id, term, year, exam_series, unit_1, unit_2, unit_3, unit_4, unit_5, unit_6, unit_7, unit_8, average )
     VALUES
      ('$admission_number','$course_id','$term','$year','$exam_series', '$introduction_to_computers','$ms_windows','$ms_excel','$ms_access','$ms_publisher','$ms_powerpoint','$ms_word','$internet_and_email','$average')") or die(mysql_error());
?>
<?php 
