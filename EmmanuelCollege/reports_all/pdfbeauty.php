...
$pdf->Cell(0,10,'Introduction to Beauty and Hair Dressing                                            '.$FBM ,0,1);
$pdf->Cell(0,10,'Beauty Therapies                                                                                  '.$R_SERVICE ,0,1);
$pdf->Cell(0,10,'Hair Dressing Technigues                                                                     '.$CT_PB ,0,1);
$pdf->Cell(0,10,'Customer Relations                                                                               '.$FOOD_SCIENCE ,0,1);
$pdf->Cell(0,10,'Entreprenuership skills                                                                        '.$FUNDAMENTALS ,0,1);
$pdf->Cell(0,10,'trends in beauty industry                                                                     '.$FRONT_OFFICE ,0,1);
$pdf->Cell(0,10,'Communication Skills                                                                          '.$COMUNICATION_SKILLS ,0,1);
$pdf->Cell(0,10,'practicals                                                                                             '.$COSTING ,0,1);
