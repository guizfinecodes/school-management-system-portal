...
$pdf->Cell(0,10,'software development and management                                             '.$FBM ,0,1);
$pdf->Cell(0,10,'security issues and management                                                         '.$R_SERVICE ,0,1);
$pdf->Cell(0,10,'networking and applications                                                               '.$CT_PB ,0,1);
$pdf->Cell(0,10,'database management and operations                                                 '.$FOOD_SCIENCE ,0,1);
$pdf->Cell(0,10,'programming laungages and practises                                                '.$FUNDAMENTALS ,0,1);
$pdf->Cell(0,10,'big data analysis methods and techniques                                           '.$FRONT_OFFICE ,0,1);
$pdf->Cell(0,10,'cloud computing technologies                                                             '.$COMUNICATION_SKILLS ,0,1);
$pdf->Cell(0,10,'communication skills are relations                                                       '.$COSTING ,0,1);
