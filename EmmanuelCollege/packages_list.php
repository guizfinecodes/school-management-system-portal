...
<div id="page-wrapper">
            <div class="container-fluid">
                ...
                <center><h4><strong>Enter marks, each student at a time</strong><h4></center>
                    ...
                    $sql ="SELECT  * from studentstable where course_id=32";
                    ...
                    ?>
                                                ...
                                                <td>
                                                <center><a href="packagesprint.php <?php echo '?id='.$id; ?>" class="btn btn-info"><i class="glyphicon glyphicon-print"></i>Print Transcript</a></center></td>
