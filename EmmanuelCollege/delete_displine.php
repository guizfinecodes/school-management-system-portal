...
if (isset($_POST['register'])){
    ...
    $del=$_POST['displine_id'];  
    $sql = "DELETE FROM displinary_case WHERE displine_id='$del'";
    mysqli_query($db,$sql);  
    if ($sql){            
     echo '<script>
            alert("student case Succsessfully deleted!!");
            window.location = "displine_review.php?id=<?php echo $id;?>";
            </script>';;
    }else
    {
        echo '<script>
            alert("student case not deleted. Contact admin");
            window.location = "displine_review.php?id=<?php echo $id;?>";
            </script>';
    }
}
...
<!--****************************************************************************-->
                        ...
                        <div class="container" style="width:100%">
                                 ...
                                 <ul class="nav nav-tabs">
                                  ...
                                  <li ><a href="displine_review.php">Student's case summary<img src="assets/img/update2.png"> </a></li>
                                  <!--<li><a href="#">Import/Export CSV<img src="assets/img/delete2.png"></a></li>-->
                                  <li class="active"><a href="delete_displine.php">Delete<img src="assets/img/delete2.png"></a></li>
                                </ul>
                            <br>
                ...
                <nav>             
                        ...
                        <div id="block_bg" class="block">   
                            <div class="navbar navbar-inner block-header">
                                <form method="post" action="delete_displine.php">
                            <table>
<tr><tr>
...
<tr><centre><td><font color="blue">&nbsp;</font></td></tr>

                             <tr>

                             <td><center><label style="color: orange;">Enter Discipline ID to DELETE:&nbsp;</label></center></td>
                             <td>
                                                <input type="number" name="displine_id" style="border-color: red;" id="course" required="" class="form-control">
                                            </td><br>
                        ...
                        <thead>
                                          <tr>
                                                ...
                                                <th><center>displine<br>ID</center></th>
