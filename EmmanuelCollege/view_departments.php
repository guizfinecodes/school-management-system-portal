...
<html lang="en">
    <head>
        ...
        <title>emmanuelcollege view departments</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">view departments</h2>
                                </div>
                            ...
                            <div class="container-fluid">
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5><u>These are the Departments available in the College</u></h5>
                                                </div>
                                            </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="myTable">
                                        ...
                                        <thead>
                                          <tr>
                                                ...
                                                <th><center>Head of the Department</center></th>
                                ...
                                $id = $row['department_id'];
                                 ...
                                 ?>
                                                <tr>
                                                <td width="30">
                                                <input id="optionsCheckbox" class="uniform_on" name="selector[]" type="radio">
                                                </td>
