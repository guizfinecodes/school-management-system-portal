...
<!--****************************************************************************-->
                         <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="view_alumnistudents.php">view alumni Students <img src="assets/img/new.png"> </a></li>
                ...
                <nav>             
                        ...
                        <div id="block_bg" class="block">   
                            ...
                            <td><input type="text" name="myInput" id="myInput" class="form-control"
                             placeholder="Student ID" onkeyup="myFunction()"></td>
                             <td><label>Name</label></td>
                             <td><input type="text" name="myInput2" id="myInput2" class="form-control"
                             placeholder="Name" onkeyup="myFunction2()"></td>
                            <td><a href="viewstudentrecord.php">View Active students list</a></td>
                             </tr>
                    ...
                    $sql ="SELECT  * from studentstable WHERE active='no' ";
                    ...
                    $id = $row['admission_number'];
                        ...
                        ?>
                                                ...
                                                <td><center><?php echo $row['username']."-".$row['zipcode']; ?></center></td>
                                                <td><center><?php echo $row['address']."-".$row['zipcode']; ?></center></td>
                                                <td><center><?php echo $row['reg_date']; ?></center></td>                           
                                            
                                                <td>
                                                <center><a href="restore_student.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-ok-circle"></i>Restore Student</a></center></td>
