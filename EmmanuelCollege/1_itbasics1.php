    ...
    <div class="container-fluid">
       <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="1_itbasics1.php" method="POST" enctype="multipart/form-data">
...
mysql_query("INSERT INTO
 marks(
    admission_number, course_id, term, year, exam_series, unit_1, unit_2, unit_3, unit_4, unit_5, unit_6, unit_7, unit_8, average )
     VALUES
      ('$admission_number','$course_id','$term','$year','$exam_series','$a','$b','$c','$d','$e','$f','$g', '$h', '$average')") or die(mysql_error());
?>
<?php 
